...
export function CourseBoard({ title, icon, courses }: CourseBoardProps) {
  return (
    <Card className="bg-card/50 border-border/60 flex-1 min-w-0">
      ...
      <CardContent>
        <div className="grid grid-cols-[1fr_1fr_1fr_auto] items-center gap-4 xl:gap-6 border-b-2 border-primary/50 pb-2 px-2 text-sm md:text-base text-muted-foreground font-bold tracking-widest">
            <span>CLASE</span>
            <span>HORA</span>
            <span>LUGAR</span>
